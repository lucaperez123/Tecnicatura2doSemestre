...
const intereses = ref([
    ...
    'Deportes al Aire Libre: Disfruto del Arbitraje de futsal que ejerso y ver deportes',
    ...
    'Lectura: Practico la lectura como un hobby, lo que me ayuda a mantener una perspectiva creativa tanto en mi vida profesional como personal.'
]);
</script>
